    ...
    <Box>
      {loading ? (
        ...
        <div className="relative">
          <Link
            href={href}
            className={`h-full flex flex-col gap-2 justify-start bg-white border border-gray-200 p-3 rounded-lg text-text1 relative ${width}`}
          >
          ...
          <div
            ...
            className="bg-white py-2 px-2 rounded-lg w-fit flex items-center gap-1 font-semibold justify-start absolute top-[120px] right-5"
          >
            <Image
              ...
              height={25}
              priority={true}
              className={handleAddToWishlist ? "fill-white" : "fill-red-600"}
            />
          </div>
        </div>
      )}
